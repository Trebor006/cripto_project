...
func GruposGenerarPantalla(w fyne.Window) fyne.CanvasObject {
	separadorTitulo := formulario.GenerarSeparadorTitulo("Grupos")
	encryptor := encryptors.GetEncryptor(encryptors.GRUPOS)
	...
	nroColumnas := formulario.newEntry()
	nroColumnas.SetPlaceHolder("Clave")
